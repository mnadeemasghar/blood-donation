    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form method="POST" action="{{ route('blood-requests.update', $blood_request->id) }}" class="p-4">
                    @csrf
                    ...
                    <div class="flex gap-3">
                        <div class="mb-3">
                            ...
                            <x-select id="blood_type" class="block mt-1 w-full" name="blood_type" value="{{ $blood_request->blood_type }}" required
                                    :options="[
                                        'A+' => 'A+',
                                        'A-' => 'A-',
                                        'B+' => 'B+',
                        ...
                        <div class="mb-3">
                            ...
                            <x-select id="city" class="block mt-1 w-full" name="city" value="{{ $blood_request->city }}" required
                                :options="[
                                    'Karachi' => 'Karachi',
                                    'Lahore' => 'Lahore',
                                    'Islamabad' => 'Islamabad',
                        ...
                        <div class="mb-3">
                            ...
                            <x-input type="text" name="area_in_city" id="area_in_city" value="{{ $blood_request->area_in_city }}" class="form-control" />
                            <x-input-error for="area_in_city" class="mt-2" />
                        </div>

                        <div class="mb-3">
                            <x-label for="building" class="form-label">{{__('Building:')}}</x-label>
                            <x-input type="text" name="building" id="building" value="{{ $blood_request->building }}" class="form-control" />
                    ...
                    <div class="flex gap-3">
                        <div class="mb-3">
                            ...
                            <x-input type="datetime-local" name="required_before" id="required_before" value="{{ date('Y-m-d\TH:i', strtotime($blood_request->required_before)) }}" class="form-control" />
                            <x-input-error for="required_before" class="mt-2" />
                        </div>

                        <div class="mb-3">
                            <x-label for="contact_no" class="form-label">{{__('Contact Number:')}}</x-label>
                            <x-input type="tel" name="contact_no" id="contact_no" value="{{ $blood_request->contact_no }}" class="form-control" />
                            <x-input-error for="contact_no" class="mt-2" />
                        </div>

                        <div class="mb-3">
                            <x-label for="contact_person_name" class="form-label">{{__('Contact Person Name:')}}</x-label>
                            <x-input type="text" name="contact_person_name" id="contact_person_name" value="{{ $blood_request->contact_person_name }}" class="form-control" />
                            <x-input-error for="contact_person_name" class="mt-2" />
                        </div>
                    </div>

                    <div class="mb-3">
                        <x-button class="btn btn-primary">{{__('Update')}}</x-button>
                    </div>
                </form>
            </div>
        </div>
